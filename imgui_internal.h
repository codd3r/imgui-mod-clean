...
namespace ImGui
{
    ...
    IMGUI_API bool          SubTabEx(const char* label, bool* active, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API void          RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f, bool border2 = false, ImColor out_col = ImColor(108, 108, 122));
